##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.1.0] date: [Thu Sep 07 18:51:02 EEST 2023]
##########################################################################################################################
...
#######################################
flash:
	openocd -f interface/stlink.cfg -f target/stm32l1x_dual_bank -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"
